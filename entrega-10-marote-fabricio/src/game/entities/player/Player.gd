...
signal cinematic_mode_set(value)
...
var cinematic_mode: bool = false setget set_cinematic_mode
...
func set_cinematic_mode(value: bool) -> void:
	cinematic_mode = value
	emit_signal("cinematic_mode_set", value)
